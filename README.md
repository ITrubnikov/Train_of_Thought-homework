...
| [`notebooks/cognopolis-m2-combat/`](notebooks/cognopolis-m2-combat/) | [Урок M2 — Боевой цикл с отступлением](https://itrubnikov.github.io/Train_of_Thought/docs/game-lessons/m2-combat/) | Уроки по игре [Cognopolis](https://kindomklaster.com). Реактивный+ агент: бой с отступлением (`fight` / `rest`), hp-guard и выбор посильной цели (гоблин vs волк). Работает против живого мира по токену из Ратуши. |
